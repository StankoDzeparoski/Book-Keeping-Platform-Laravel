...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            <h1 class="text-3xl font-bold text-gray-900 mb-6">Create Equipment</h1>
                ...
                <form action="{{ route('equipment.store') }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <select name="category"
                            ...
                            <option value="Computer" {{ old('category') == 'Computer' ? 'selected' : '' }}>Computer
                            </option>
                            <option value="Peripherals" {{ old('category') == 'Peripherals' ? 'selected' : '' }}>
                                Peripherals
                            </option>
                            <option value="Ergonomics" {{ old('category') == 'Ergonomics' ? 'selected' : '' }}>
                                Ergonomics
                            </option>
                        </select>
